...
[![Build Status](https://github.com/btcnash/go-binance/actions/workflows/check.yml/badge.svg?branch=master)](https://github.com/btcnash/go-binance/actions/workflows/check.yml)
[![GoDoc](https://godoc.org/github.com/btcnash/go-binance/v2?status.svg)](https://godoc.org/github.com/btcnash/go-binance/v2)
[![Go Report Card](https://goreportcard.com/badge/github.com/btcnash/go-binance)](https://goreportcard.com/report/github.com/btcnash/go-binance)
[![codecov](https://codecov.io/gh/btcnash/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/btcnash/go-binance)
...
```shell
go get github.com/btcnash/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/btcnash/go-binance/v1
```
...
import (
    ...
    "github.com/btcnash/go-binance/v2/futures" // optional package
    "github.com/btcnash/go-binance/v2/delivery" // optional package
    "github.com/btcnash/go-binance/v2/options" // optional package
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/btcnash/go-binance/v2) for full references.
